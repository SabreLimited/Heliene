report 59104 "Sales Order Test Ext"
{
    // version NAVNA11.00

    DefaultLayout = RDLC;
    RDLCLayout = './Sales Order Test.rdlc';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(FormattedShptDate_SalesHeader; ExtensionFunctions.getFormattedDate("Sales Header"."Shipment Date")) { }//Sbr-Jo M3928
                    ...
                    column(FormattedOrderDate_SalesHeader; ExtensionFunctions.getFormattedDate("Sales Header"."Order Date")) { }//Sbr-Jo M3928
