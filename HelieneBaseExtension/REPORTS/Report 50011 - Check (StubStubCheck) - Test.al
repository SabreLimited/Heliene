report 59111 "Check (S/S/C) - Test"
{
    // version NAVNA11.00.00.21836
    //SBR-Jo M3928
    DefaultLayout = RDLC;
    RDLCLayout = './Check (StubStubCheck) - Test.rdlc';
    CaptionML = ENU = 'Check (Stub/Stub/Check)',
                ESM = 'Cheque (Serie/Serie/Cheque)',
                FRC = 'Chèque (Talon/Talon/Chèque)',
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            dataitem(CheckPages; "Integer")
            {
                ...
                dataitem(PrintSettledLoop; "Integer")
                {
                    ...
                    column(FormattedDocDate; ExtensionFunctions.getFormattedDate(DocDate)) { }//Sbr-Jo M3928
                ...
                dataitem(PrintCheck; "Integer")
                {
                    ...
                    column(FormattedStub2DocDate_1_; ExtensionFunctions.getFormattedDate(Stub2DocDate[1])) { }//Sbr-Jo M3928
                    ...
                    column(FormattedStub2DocDate_2_; ExtensionFunctions.getFormattedDate(Stub2DocDate[2])) { }//Sbr-Jo M3928
                    ...
                    column(FormattedStub2DocDate_3_; ExtensionFunctions.getFormattedDate(Stub2DocDate[3])) { }//Sbr-Jo M3928
                    ...
                    column(FormattedStub2DocDate_4_; ExtensionFunctions.getFormattedDate(Stub2DocDate[4])) { }//Sbr-Jo M3928
                    ...
                    column(FormattedStub2DocDate_5_; ExtensionFunctions.getFormattedDate(Stub2DocDate[5])) { }//Sbr-Jo M3928
                    ...
                    column(FormattedStub2DocDate_6_; ExtensionFunctions.getFormattedDate(Stub2DocDate[6])) { }//Sbr-Jo M3928
                    ...
                    column(FormattedStub2DocDate_7_; ExtensionFunctions.getFormattedDate(Stub2DocDate[7])) { }//Sbr-Jo M3928
                    ...
                    column(FormattedStub2DocDate_8_; ExtensionFunctions.getFormattedDate(Stub2DocDate[8])) { }//Sbr-Jo M3928
                    ...
                    column(FormattedStub2DocDate_9_; ExtensionFunctions.getFormattedDate(Stub2DocDate[9])) { }//Sbr-Jo M3928
                    ...
                    column(FormattedStub2DocDate_10_; ExtensionFunctions.getFormattedDate(Stub2DocDate[10])) { }//Sbr-Jo M3928
                ...
                group(Options)
                {
                    ...
                    field(UseCheckNo; UseCheckNo)
                    {
                        ...
                        ToolTipML = ENU = 'Specifies the number of the last check that was issued. If you have entered a number in the Last Check No. field in the Bank Account Card window, the number will appear here when you fill in the Bank Account field.',
                                    ESM = 'Especifica el número del último cheque emitido. Si especificó un número en el campo Òlt. n.º cheque de la ventana Ficha banco, el número aparecerá aquí cuando rellene el campo Banco.',
