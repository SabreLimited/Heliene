report 59100 "Standard Sales Invoice MOD"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column("ExternalDocNo"; SBRExternalDocumentNo)
                {
                }
                ...
                dataitem(AssemblyLine; "Posted Assembly Line")
                {
                    ...
                    {
                        //DecimalPlaces = 0:5; //SBR-Jo Conversion to AL
                    }
                ...
                begin
                    ...
                    IF SalesInvoiceHeader.GET(Line."Document No.") then
                        SBRExternalDocumentNo := SalesInvoiceHeader."External Document No.";
                    //SBR-Jo
                end;
